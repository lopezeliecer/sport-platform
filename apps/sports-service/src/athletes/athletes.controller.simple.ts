...
export class AthletesController {
  ...
  async create(
    ...
    const athlete = await this.athletesService.create(createAthleteDto, clubId, userId);
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a paginated list of athletes with optional filtering and search.',
  })
  @ApiHeader({
    name: 'x-club-id',
    description: 'Club ID for multi-tenant context',
  ...
  async findAll(
    ...
    const result = await this.athletesService.findAll(searchDto, clubId, userId);
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a specific athlete by their ID with detailed information.',
  })
  ...
  async update(
    ...
    const athlete = await this.athletesService.update(id, updateAthleteDto, clubId, userId);
  ...
  @ApiOperation({
    ...
    description: 'Soft deletes an athlete. Requires ADMIN or DIRECTOR permissions.',
  })
  @ApiParam({ name: 'id', description: 'Athlete ID', type: String })
  @ApiHeader({
    name: 'x-club-id',
  ...
  async getStatistics(
    ...
    const statistics = await this.athletesService.getStatistics(id, clubId, userId);
