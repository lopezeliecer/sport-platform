...
export class AuthController {
  ...
  async getActiveSessions(@Req() req: any): Promise<SessionInfoDto[]> {
    const sessions = await this.authService.getUserActiveSessions(req.user.userId);
  ...
  async revokeSession(@Param('sessionId') sessionId: string, @Req() req: any): Promise<void> {
