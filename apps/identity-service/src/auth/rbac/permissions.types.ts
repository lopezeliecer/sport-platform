...
export const ROLE_PERMISSIONS: Record<string, RolePermissions> = {
  ...
  COACH: {
    role: 'COACH',
    description: 'Gestión de atletas, entrenamientos, performance, comunicación básica',
    permissions: [
      // Athletes management
      ...
      { module: 'medical', action: 'read', scope: 'club', conditions: { level: 'basic' } },
    ],
  },

  ATHLETE: {
    role: 'ATHLETE',
    description: 'Ver información personal, entrenamientos asignados, registrar performance',
    permissions: [
      // Own athlete data
      { module: 'athletes', action: 'read', scope: 'own' },
      { module: 'athletes', action: 'update', scope: 'own', conditions: { fields: ['emergency_contact', 'profile'] } },
  ...
  MEDICAL_STAFF: {
    role: 'MEDICAL_STAFF',
    description: 'Acceso completo a datos médicos, restricciones, recomendaciones',
    permissions: [
      // Athletes medical data
      { module: 'athletes', action: 'read', scope: 'club' },
      { module: 'athletes', action: 'update', scope: 'club', conditions: { fields: ['medical_data'] } },
      ...
      { module: 'communications', action: 'create', scope: 'club', conditions: { type: 'medical' } },
      { module: 'communications', action: 'send_notifications', scope: 'club', conditions: { type: 'medical' } },
    ],
  },
  ...
  PARENT: {
    ...
    permissions: [
      ...
      { module: 'athletes', action: 'read', scope: 'own', conditions: { relation: 'child' } },
      { module: 'athletes', action: 'update', scope: 'own', conditions: { relation: 'child', fields: ['emergency_contact'] } },
      
      // Children training
      { module: 'training', action: 'read', scope: 'own', conditions: { relation: 'child' } },
      
      // Children performance
      { module: 'performance', action: 'read', scope: 'own', conditions: { relation: 'child' } },
      
      // Children competitions
      { module: 'competitions', action: 'read', scope: 'own', conditions: { relation: 'child' } },
      
      // Payments for children
      { module: 'payments', action: 'read', scope: 'own', conditions: { relation: 'child' } },
      { module: 'payments', action: 'manage', scope: 'own', conditions: { relation: 'child' } },
      
      // Communications
      { module: 'communications', action: 'read', scope: 'club' },
      { module: 'communications', action: 'create', scope: 'club', conditions: { type: 'parent_inquiry' } },
      
      // Children medical data (basic)
      { module: 'medical', action: 'read', scope: 'own', conditions: { relation: 'child', level: 'basic' } },
    ],
  },
