...
export function hasAnyPermission(
  ...
  return checks.some((check) => hasPermission(userRole, check.module, check.action, check.scope));
}
...
export function hasAllPermissions(
  ...
  return checks.every((check) => hasPermission(userRole, check.module, check.action, check.scope));
}
